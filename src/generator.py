...
#         # 'gpu_layers=0' forces CPU usage. Increase if you have a GPU.
...
#         # Construct prompt for Phi-3 format
#         prompt = f"""<|user|>
...
#             stop=["<|end|>"] # Stop generation at end token
#         )
#         return response
...
<|end|>
<|assistant|>"""    
        # Added stream=True and converted to a generator
